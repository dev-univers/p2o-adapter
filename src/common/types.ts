...
export function dangerouslyGetAllMethodNames(obj: object): string[] {
	const methods: string[] = [];
...
export function createProxyObject<T extends object>(moduleId: string,methodNames: string[], invoke: (moduleId: string,method: string, args: unknown[]) => unknown): T {
